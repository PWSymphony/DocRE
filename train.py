...
#         self.true_num += output[1]
#         self.pred_true_num += output[0]
#         # pred, loss = self.loss_fn(pred=output, batch=batch)
#         # self.compute_output(output=output, batch=batch)
#
...
#         log_dict['recall'] = round(self.pred_true_num / self.true_num, 4)
...
#         dev_result = dict()
#         dev_result['recall'] = round(self.pred_true_num / self.true_num, 4)
